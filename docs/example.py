...
def main():
    ...
    sample_latent_vars_given_data(
        train_data[0], model_path=f"{HERE}/model_exploration/model_z{Z_SIZE}",
    ...
    sample_latent_vars_given_data(
        reconstructed, model_path=f"{HERE}/model_exploration/model_z{Z_SIZE}",
