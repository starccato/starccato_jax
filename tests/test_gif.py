...
from starccato_jax.plotting.gif_generator import generate_gif  # Import your function
...
def test_generate_gif(create_test_images, duration, final_pause, outdir):
    ...
    # Call function
    generate_gif(os.path.join(temp_dir, "frame_*.png"), output_gif, duration, final_pause)
    ...
    with Image.open(output_gif) as gif:
        ...
        assert gif.n_frames == len(test_images), "Incorrect number of frames in GIF!"
